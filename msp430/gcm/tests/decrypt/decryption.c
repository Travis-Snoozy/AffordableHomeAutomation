...
static uint8_t tag[16]; // Just here to keep the debug script warm
...
void firmware_main() {
    ...
    {
        init();
        verify(c_gcm_aes_decrypt(iv, ekey, hash_const, Taglen, Tag, PTlen, CT, AADlen, AAD));
    }
}
